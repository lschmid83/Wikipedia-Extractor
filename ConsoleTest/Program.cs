...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        using (var indexSearcher = new PageIndexSearcher(@"e:\Data\enwiki-20190701-pages-articles-multistream-index.txt"))
        {
            ...
            using (var dataDumpReader = new DataDumpReader(@"e:\Data\enwiki-20190701-pages-articles-multistream.xml.bz2"))
            {
